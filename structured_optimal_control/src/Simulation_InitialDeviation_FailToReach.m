...
% Correspond to Fig. 7(e)-(f) in the following paper
...
% fails to reach the target velocity (see Section IV.C in the paper)
...
% mix = 1; v_ctr_dev = 1; --> Fig. 7(e)
% mix = 1; v_ctr_dev = -1; --> Fig. 7(f)
...
plot(0:0.1:100,v_ctr*ones(length(0:0.1:100),1),'-.k','linewidth',0.7);
